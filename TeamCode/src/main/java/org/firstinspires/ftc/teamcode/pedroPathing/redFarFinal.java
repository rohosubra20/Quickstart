...
@Autonomous(name = "redFarFinal")
public class redFarFinal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            //shoot at the front
            move("forward", 3100, 0, 1500);
            sleep(200);
            rotate("right",-35, 1300);
            // move("forward", 200, 45, 2000);
            ...
            // leftFlywheel.setVelocity(shooterVelocity);
            // rightFlywheel.setVelocity(shooterVelocity);
            //move("backward",200,45,2000);
            //sleep(200);
            rotate("right",-90,1300);
            sleep(200);
            // move("left",500,90,2000);
            // sleep(200);
            move("forward",1300,-90,1500);
            sleep(200);
            move("backward",1150,-90,1500);
            sleep(200);
            // move("right",500,90,2000);
            // sleep(200);
            ...
            rotate("right",-90,1300);
            sleep(200);
            move("right",1000,-90,1500);
            sleep(200);
            move("forward", 1400, -90, 1500);
            sleep(200);
            rotate("left",-45, 1300);
            sleep(200);
            move("left",1870,-45,1500);
            sleep(200);
            ...
            rotate("right",-90,1300);
            sleep(200);
            move("right",2350,-90,1500);
            sleep(200);
            move("forward", 1350, -90, 1500);
            sleep(200);
            move("left",1050,-90,1500);
            sleep(200);
            rotate("left",-45, 1300);
            move("left",1900,-45,1500);
            // move("left",300,90,2000);
            // sleep(200);
            // rotate("right",45, 1250);
            gate.setPosition(openPos);
            sleep(1500);
            gate.setPosition(closePos);
            move("right",1000,-45,1500);
            telemetry.addData("done",true);
            telemetry.update();

            // move("left",1500,0,1500);
            // sleep(200);
            // move("right",1500,0,1500);
