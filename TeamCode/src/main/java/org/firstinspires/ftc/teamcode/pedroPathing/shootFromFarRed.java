...
@Autonomous(name = "shootFromFarRed")
public class shootFromFarRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                sleep(300);
                if (i != 2) gate.setPosition(closePos);
            }
            sleep(1000);
            gate.setPosition(closePos);
            move("right",1000,0,1000);
