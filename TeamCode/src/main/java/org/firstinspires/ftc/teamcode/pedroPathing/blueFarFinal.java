...
public class blueFarFinal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            sleep(200);
            move("backward",1100,90,1500);
            sleep(200);
            // move("right",500,90,2000);
            // sleep(200);

            rotate("right",50, 1300);
            gate.setPosition(openPos);
            sleep(1500);
            gate.setPosition(closePos);
            ...
            rotate("left",90,1300);
            sleep(200);
            move("left",1100,90,1500);
            sleep(200);
            move("forward", 1400, 90, 1500);
            sleep(200);
            rotate("right",45, 1300);
            sleep(200);
            move("right",1900,45,1500);
            sleep(200);
            ...
            rotate("left",90,1300);
            sleep(200);
            move("left",2350,90,1500);
            sleep(200);
            move("forward", 1400, 90, 1500);
            sleep(200);
            move("right",1050,90,1500);
            sleep(200);
            rotate("right",45, 1300);
            move("right",1900,45,1500);
